...
\author{Akash Kolukonda (akk424@lehigh.edu), Zihao Xin (zix524@lehigh.edu), Hengde Dai (hed424@lehigh.edu)}
...
This project implements a pipelined RISC-V processor supporting the RV32I instruction set. We developed our baseline processor (Phase 0) by extending the MERL-DSU RISC-V Pipeline Core open-source framework with significant enhancements including complete data forwarding logic and extended instruction support.
